...
Este proyecto fue construido utilizando un stack moderno para garantizar alto rendimiento, tipado estricto y un diseño responsivo:
...
Si deseas explorar el código o ejecutar el entorno en tu máquina local, sigue estos pasos:

1. Clona el repositorio:
   ```bash
   git clone [https://github.com/olavuenaz/portafolio.git](https://github.com/olavuenaz/portafolio.git)
